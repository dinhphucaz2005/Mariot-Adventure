package com.example.androidgames.framework.gfx;
...
import com.example.androidgames.framework.fileio.AndroidFileIO;
import com.example.androidgames.framework.input.AndroidInput;
import com.example.androidgames.framework.sfx.AndroidAudio;
...
public abstract class AndroidGame extends Activity implements Game {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.v("phantom"," window width & height (in pixels): " + w + ", " + h);
