...
public class MarioResourceManager
{
	...
	public  void loadResouces(){
		if (firstTimeCreate==true){
			...
			// left phantom
			Mario_Big_Left_Still = loadImage("phantom/Mario_Big_Left_Still.png");
			Mario_Big_Left_1 = loadImage("phantom/Mario_Big_Left_1.png");
			Mario_Big_Left_2 = loadImage("phantom/Mario_Big_Left_2.png");
			Mario_Big_Left_Run_1 = loadImage("phantom/Mario_Big_Left_Run_1.png");
			Mario_Big_Left_Run_2 = loadImage("phantom/Mario_Big_Left_Run_2.png");
			Mario_Big_Crouch_Left = loadImage("phantom/Mario_Big_Crouch_Left.png");
			Mario_Big_Jump_Left = loadImage("phantom/Mario_Big_Jump_Left.png");
			Mario_Big_Change_Direction_Left = loadImage("phantom/Mario_Big_Change_Direction_Left.png");
			// Right phantom
			Mario_Big_Right_Still = loadImage("phantom/Mario_Big_Right_Still.png");
			Mario_Big_Right_1 = loadImage("phantom/Mario_Big_Right_1.png");
			Mario_Big_Right_2 = loadImage("phantom/Mario_Big_Right_2.png");
			Mario_Big_Right_Run_1 = loadImage("phantom/Mario_Big_Right_Run_1.png");
			Mario_Big_Right_Run_2 = loadImage("phantom/Mario_Big_Right_Run_2.png");
			Mario_Big_Crouch_Right = loadImage("phantom/Mario_Big_Crouch_Right.png");
			Mario_Big_Jump_Right = loadImage("phantom/Mario_Big_Jump_Right.png");
			Mario_Big_Change_Direction_Right = loadImage("phantom/Mario_Big_Change_Direction_Right.png");
			//Fire Left Mario
			Mario_Big_Left_Still_Fire = loadImage("phantom/Mario_Big_Left_Still_Fire.png");
			Mario_Big_Left_1_Fire = loadImage("phantom/Mario_Big_Left_1_Fire.png");
			Mario_Big_Left_2_Fire = loadImage("phantom/Mario_Big_Left_2_Fire.png");
			Mario_Big_Left_Run_1_Fire = loadImage("phantom/Mario_Big_Left_Run_1_Fire.png");
			Mario_Big_Left_Run_2_Fire = loadImage("phantom/Mario_Big_Left_Run_2_Fire.png");
			Mario_Big_Crouch_Left_Fire = loadImage("phantom/Mario_Big_Crouch_Left_Fire.png");
			Mario_Big_Jump_Left_Fire = loadImage("phantom/Mario_Big_Jump_Left_Fire.png");
			Mario_Big_Change_Direction_Left_Fire = loadImage("phantom/Mario_Big_Change_Direction_Left_Fire.png");
			
			//Fire Right Mario
			Mario_Big_Right_Still_Fire = loadImage("phantom/Mario_Big_Right_Still_Fire.png");
			Mario_Big_Right_1_Fire = loadImage("phantom/Mario_Big_Right_1_Fire.png");
			Mario_Big_Right_2_Fire = loadImage("phantom/Mario_Big_Right_2_Fire.png");
			Mario_Big_Right_Run_1_Fire = loadImage("phantom/Mario_Big_Right_Run_1_Fire.png");
			Mario_Big_Right_Run_2_Fire = loadImage("phantom/Mario_Big_Right_Run_2_Fire.png");
			Mario_Big_Crouch_Right_Fire = loadImage("phantom/Mario_Big_Crouch_Right_Fire.png");
			Mario_Big_Jump_Right_Fire = loadImage("phantom/Mario_Big_Jump_Right_Fire.png");
			Mario_Big_Change_Direction_Right_Fire = loadImage("phantom/Mario_Big_Change_Direction_Right_Fire.png");
			
			Mario_Small_Left=loadImage("phantom/Mario_Small_Left.png");
			Mario_Small_Right=loadImage("phantom/Mario_Small_Right.png");
			
			Mario_swim_left_small=new SpriteMap(loadImage("phantom/Mario_Small_Swim_Left.png"), 4, 1).getSprites();
			Mario_swim_right_small=new SpriteMap(loadImage("phantom/Mario_Small_Swim_Right.png"), 4, 1).getSprites();
			Mario_swim_left_big=new SpriteMap(loadImage("phantom/Mario_Big_Swim_Left.png"), 4, 1).getSprites();
			Mario_swim_right_big=new SpriteMap(loadImage("phantom/Mario_Big_Swim_Right.png"), 4, 1).getSprites();
			Mario_swim_left_fire=new SpriteMap(loadImage("phantom/Mario_Fire_Swim_Left.png"), 4, 1).getSprites();
			Mario_swim_right_fire=new SpriteMap(loadImage("phantom/Mario_Fire_Swim_Right.png"), 4, 1).getSprites();
			  
				
				
			Mario_Flip=loadImage("phantom/Mario_Flip.png");
			// coin
