package com.example.androidgames.phantom.objects.base;
...
import com.example.androidgames.phantom.core.animation.Sprite;
...
public class Creature extends CollidableObject {
	...
	// that are used to determine when phantom comes within range of a creature.
